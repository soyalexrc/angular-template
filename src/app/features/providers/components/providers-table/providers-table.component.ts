...
export class ProvidersTableComponent implements OnInit, AfterViewInit {
  ...
  @Output() editProvider: EventEmitter<any> = new EventEmitter<any>()
  @Output() deleteProvider: EventEmitter<any> = new EventEmitter<any>()
  ...
  ngOnInit(): void {
    this.dataSource = new MatTableDataSource(PROVIDERS_DATA)
  }
